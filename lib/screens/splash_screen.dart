...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    super.initState();
    // Remove automatic navigation - now controlled by button
  }
            ...
            children: [
              LayoutBuilder(
                builder: (context, constraints) {
                  // Calculate responsive size - more reasonable sizing
                  double screenWidth = constraints.maxWidth;
                  double screenHeight = constraints.maxHeight;

                  // Use a percentage of the smaller dimension for better proportions
                  double maxSize = screenWidth < screenHeight
                      ? screenWidth
                      : screenHeight;
                  double animationSize =
                      maxSize *
                      0.85; // 85% of screen size - bigger but not overwhelming
              ...
              // Get Started Button with pulsing effect
              ElevatedButton(
                    onPressed: () {
