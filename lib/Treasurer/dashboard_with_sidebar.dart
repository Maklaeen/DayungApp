...
class TreasurerDashboardEntry extends StatelessWidget {
  const TreasurerDashboardEntry({super.key});
    ...
    return SharedSidebarLayout(
      ...
      navigationItems: [
        SidebarNavItem(
          ...
          label: 'Dashboard',
          pageKey: 'dashboard',
          page: const TreasurerDashboardPage(),
      ...
      child: const TreasurerDashboardPage(),
    );
  }
}
