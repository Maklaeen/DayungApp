...
class CollectorDashboardEntry extends StatelessWidget {
  const CollectorDashboardEntry({super.key});
    ...
    return SharedSidebarLayout(
      ...
      navigationItems: [
        SidebarNavItem(
          ...
          label: 'Dashboard',
          pageKey: 'dashboard',
          page: const CollectorDashboardPage(),
      ...
      child: const CollectorDashboardPage(),
    );
  }
}
