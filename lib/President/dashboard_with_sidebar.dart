...
class PresidentDashboardEntry extends StatelessWidget {
  const PresidentDashboardEntry({super.key});
    ...
    return SharedSidebarLayout(
      ...
      navigationItems: [
        SidebarNavItem(
          ...
          label: 'Dashboard',
          pageKey: 'dashboard',
          page: const PresidentDashboardPage(),
      ...
      child: const PresidentDashboardPage(),
    );
  }
}
